...
class dataset_info():
    def __init__(self):
        self.prefix = [
                       './3ddfa/test_align_yaw/Images',  #'./3ddfa/example/Images',
                       #'PREFIX-TO-YOUR-DATASET'
                       ]
        self.file_list = [
                     './3ddfa/test_align_yaw/file_list.txt',  #'./3ddfa/example/file_list.txt',
                     #'YOUE-FILE-LIST.txt'
                     ]

        self.land_mark_list = [
                          './3ddfa/test_align_yaw/realign_lmk',  #./3ddfa/example/realign_lmk',
                          #'LANDMARKS-OF-FACES-IN-YOUR-DATASET'
                          ]

        self.params_dir = [
                           './3ddfa/test_align_yaw/results',  #'./3ddfa/results',
                           #'3DFITTING-RESULTS-HOME-DIR'
                           ]
        self.dataset_names = {'test_align': 0, 'YOUR-DATASET': 1}
