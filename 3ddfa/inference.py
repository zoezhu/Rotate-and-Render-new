'''
(mvb) python inference.py --img_list test_align/file_list.txt --img_prefix test_align/Images --save_lmk_dir test_align --save_dir test_align/results
'''
...
def main(args):
    ...
    # img_list = [os.path.basename(path) for path in glob(args.img_prefix+'/*.jpg')]
